...
// identificativos del negocio (config.ts) para cumplir la LSSI.
// =============================================================================
    ...
    bloques: [
      {
        titulo: "1. Objeto",
        parrafos: [
          `El servicio de reserva online permite a los clientes de ${CONFIG.nombre} elegir día, hora y servicio, y solicitar una cita en el negocio.`,
        ],
      },
      {
        titulo: "2. Cómo funciona",
        parrafos: [
          "El cliente selecciona el día (con hasta una semana de antelación), la hora libre y el servicio, e introduce su nombre y teléfono. Al confirmar, se envía la solicitud de reserva, que será gestionada por el negocio.",
      ...
      },
      {
        ...
        parrafos: [
          "El negocio podrá modificar los horarios y servicios mostrados, así como cancelar una cita en caso de incumplimiento de estas condiciones, informando al cliente siempre que sea posible.",
        ],
      },
      {
