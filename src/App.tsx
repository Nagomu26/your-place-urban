...
function aplicarSEO() {
  document.title = `${CONFIG.nombre} · Street | ${CONFIG.tituloSeo} | Cita online`;
  const meta = document.querySelector<HTMLMetaElement>('meta[name="description"]');
  if (meta) {
    meta.content = `${CONFIG.nombre} en ${CONFIG.ciudad}. ${CONFIG.lemaSeo} Pide tu cita online en segundos.`;
  }
...
export default function App() {
  ...
  return (
    <div className="bg-night font-body text-bone2 antialiased">
      <Header />
      <main>
        <Hero />
        <Services />
